...
public class ConstantValue {
	 ...
	 * 钓鱼鱼塘缓存前缀
	 */
//	public static final String REDIS_GOwelfare_POND_PREFIX = "gowelfare_";
	 ...
	 * 渔场品质
	 */
	public static final String REDIS_welfare_QUALITY = "QUALITY_";



	private final String PREFIX = "TREEHOUSE_";

	public static final String COMMONwelfare = "COMMONwelfare_";
	...
	public static final String COMMONwelfare_FISH = "COMMONwelfare_FISH";

	public static final String SENIOR_FISH = "SENIOR_FISH";

	public static final String RARE_FISH = "RARE_FISH";

	public static final String COMMONwelfare_PROBABILITY = "COMMONwelfare_PROBABILITY";
	 ...
	 * 转盘随机
	 */
	public static final String DIAL_RANDOM = "DIAL_RANDOM";
	/**
	 * 转盘随机权重
	 */
	public static final String DIAL_RANDOM_WEIGHT = "DIAL_RANDOM_WEIGHT";
